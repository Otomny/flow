...
import fr.omny.flow.aop.MongoRepositoryProxy;
...
public class RepositoryFactory {
  ...
  public static <T, ID, C extends CrudRepository<T, ID>>
      C createRepository(Class<? extends C> repositoryClass) {
  ...
  public static <T, ID> JavaRepository<T, ID>
  createJavaRepository(Class<?> repositoryClass) {
    try {
      ...
      String collectionName =
          repositoryData.name().equals("__class")
  ...
  @SuppressWarnings("unchecked")
  public static <T, ID, C extends CrudRepository<T, ID>>
      C createMongoRepository(Class<? extends C> repositoryClass) {
    var typeNames = Reflections.findTypeName(
   ...
   */
  @SuppressWarnings("unchecked")
  public static <T, ID> RedisRepository<T, ID>
  createRedisRepository(Class<?> repositoryClass) {
    var typeNames = Reflections.findTypeName(
   ...
   * @return
   */
  public static <T> BiFunction<T, Object, Object>
  createSetter(Class<?> dataClass, Field field) {
  ...
  public static <T> Function<T, Object> createGetter(Class<?> dataClass,
    ...
    try {
      var method =
          dataClass.getDeclaredMethod(getterMethodName, new Class<?>[] {});
   ...
   */
  @SuppressWarnings("unchecked")
  public static <T, ID> Function<T, ID>
  mappingFactory(Class<?> repositoryClass, Class<?> repositoryInterface) {
    var typeNames = Reflections.findTypeName(
    ...
    for (var field : dataType.getDeclaredFields()) {
      if (field.isAnnotationPresent(Id.class) &&
          keyType.isAssignableFrom(field.getType())) {
