...
public abstract class CmdArgument<T> implements CommandComponent {
	 ...
	 */
	public abstract Optional<T> getValue(String textValue, CommandSender sender, Arguments precedentArguments);
	 ...
	 */
	public abstract List<String> getValues(CommandSender sender, Arguments precedentArguments);
